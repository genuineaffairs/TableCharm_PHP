...
Stores - Events Extension ", "siteevent" => 'SEAO - Advanced Events ');
    ...
    if(Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitealbumalbum')) {
    //VALUE FOR ENABLE/DISABLE GETLINK
    $this->addElement('Radio', 'seaocore_photo_getlink', array(
        'label' => 'Get Link',
        'description' => 'Do you want the "Get Link" link to be shown in the Photo Lightbox Viewer below the photos? This link will enable logged-in users to get link of photos that they can view (Members will also be able to send the photo to friends in messages.).',
        'multiOptions' => array(
            1 => 'Yes',
            0 => 'No'
        ),
    ...
    $this->addElement('Radio', 'seaocore_photo_sendmail', array(
        'label' => 'Send Mail',
        'description' => 'Do you want the "Send Mail" link to be shown in the Photo Lightbox Viewer below the photos? This link will enable logged-in users to send the photos by Email that they can view.',
        'multiOptions' => array(
            1 => 'Yes',
            0 => 'No'
        ),
