			...
			<li>
				<div class="steps">
					...
					<div id="fbstep-1" style='display: none;'>
						<p>
            	<?php echo $this->translate("Go to this URL for steps to configure basic Facebook Integration on your SocialEngine website : ");?><a href="http://youtu.be/lJl9a8v_dQc 
" target="_blank" style="color:#5BA1CD;">http://youtu.be/lJl9a8v_dQc</a><br/>    
            </p>
					</div>
				</div>	
			</li>	
			...
			<li>	
                ...
                <?php echo   $this->translate("d) <b>Your site's canvas url</b>") . ' => <b> http://' . $_SERVER['HTTP_HOST'] . Zend_Controller_Front::getInstance()->getBaseUrl() . '/seaocore/auth/fb-Invite/ </b> in the \'Canvas URL\' field in the \'App on facebook\' section.' ;?><br />
                
                <?php echo $this->translate("e) If your site runs on https, then <b>Your site's secure canvas url</b>") . ' => <b> https://'. $_SERVER['HTTP_HOST'] . Zend_Controller_Front::getInstance()->getBaseUrl() . '/seaocore/auth/fb-Invite/ </b> in the \'Secure Canvas URL\' field in the \'App on facebook\' section.' ;?><br />                
