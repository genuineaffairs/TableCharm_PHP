 ...
 */
class Sitepagepoll_Widget_LikeSitepagepollsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->listLikedPolls = $listLikedPolls = Engine_Api::_()->getDbtable('polls', 'sitepagepoll')->getPollListing('Most Liked', $values);
