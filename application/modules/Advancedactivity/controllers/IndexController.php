...
//    }
  ...
  public function unlikeAction() {
    ...
    if (null === $this->_helper->contextSwitch->getCurrentContext()) {
      ...
      $method = 'update';
      $onViewPage = $this->_getParam('onViewPage');
      $this->view->body = $this->view->$helper($action, array('noList' => true, 'onViewPage' => $onViewPage, 'viewAllLikes' => $onViewPage, 'viewAllComments' => $onViewPage), $method = 'update');
    }
  }
  ...
  public function commentAction() {
    ...
    if (null === $this->_getParam('format', null)) {
      ...
      $this->view->body = $this->view->$helper($action, array('noList' => true, 'submitComment' => true, 'onViewPage' => $onViewPage, 'viewAllLikes' => $onViewPage, 'viewAllComments' => $onViewPage), $method, $show_all_comments);
    }
  }
