...
<ul class="sitepage_sidebar_list">
  <?php foreach ($this->listVotedPolls as $sitepagepoll): ?>
    <li>
      <?php 
  ...
  <li class="sitepage_sidebar_list_seeall">
		<a href='<?php echo $this->url(array('votedpoll'=> 1), 'sitepagepoll_browse', true) ?>'><?php echo $this->translate('See All');?> &raquo;</a>
	</li>
</ul>