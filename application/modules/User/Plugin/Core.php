...
//      }
  ...
  public function postDispatch(Zend_Controller_Request_Abstract $request)
  {
    ...
    if ($friendRequestCount) {
      $view->headScript()->prependScript('var friend_request_count = ' . $friendRequestCount);
    }
    $view->headScript()->appendFile($view->layout()->staticBaseUrl . 'application/modules/User/externals/scripts/global.js');
    if($request->getActionName() === 'browse' && $request->getModuleName() === 'user') {
      $view->headScript()->appendFile($view->layout()->staticBaseUrl . 'application/modules/User/externals/scripts/local.js');
    }
  }
