 ...
 * @license    http://www.socialengine.com/license/
 */
class Sitemobile_Widget_UserProfileFriendsFollowersController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $sitemobileFriendFollower = Zend_Registry::isRegistered('sitemobileFriendFollower') ?  Zend_Registry::get('sitemobileFriendFollower') : null;
    ...
    if (($paginator->getTotalItemCount() <= 0) || empty($sitemobileFriendFollower)) {
      return $this->setNoRender();
    }
