...
function continuelayout() {
  window.location.href= '<?php echo $this->url(array('action' => 'save-user-driven-layout', 'controller' => 'mobile-layout', 'module' => 'sitepage', 'page_id' => $this->page_id ), 'default', true)?>';
  Smoothbox.close();
}
