 ...
 * @version    $Id: add-event-of-day.tpl 2011-08-026 9:40:21Z SocialEngineAddOns $
...
<script type="text/javascript">
  ...
  {
    var contentAutocomplete = new Autocompleter.Request.JSON('title', '<?php echo $this->url(array('module' => 'sitepageevent', 'controller' => 'settings', 'action' => 'get-event'), 'admin_default', true) ?>', {
      'postVar' : 'text',
      'minLength': 1,
      'selectMode': 'pick',
