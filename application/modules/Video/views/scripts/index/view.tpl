 ...
 * @version    $Id: view.tpl 10215 2014-05-14 19:49:18Z andres $
 * @author     Jung
 */
?>
...
<?php if( $this->video->type == 3 && ( $this->video_extension === 'flv' || !$this->mobile ) ):
  $this->headScript()
...
<div class="video_view video_view_container">
  ...
  <div id="video_embed" class="video_embed">
    <?php if ($this->mobile && $this->video_extension !== 'flv'): ?>
