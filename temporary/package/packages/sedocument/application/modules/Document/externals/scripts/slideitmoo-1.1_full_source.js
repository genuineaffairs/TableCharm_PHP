...
var SlideItMoo = new Class({
  ...
  /* determines the current index in element page */
  ...
  sendajax: function (direction, obj) { 	
    if (fwdbck_click == 1 ) {
      fwdbck_click = 2; 
          ...
          document.getElementById('SlideItMoo_forward_loding').style.display= 'block';
        }else{
          document.getElementById('SlideItMoo_back').style.display= 'none';
          document.getElementById('SlideItMoo_back_dis').style.display= 'none';
          document.getElementById('SlideItMoo_back_loding').style.display= 'block';
            ...
            document.getElementById('SlideItMoo_forward_loding').style.display= 'none';
            document.getElementById('SlideItMoo_back_loding').style.display= 'none';
					}
				});
				request.send();
			}
