...
var getLinkContent = function(event) {
  ...
  if (sitepagevideoPlugin && (uri_link.match(/(www\.|)youtube\.com\/watch/ig) || uri_link.match(/(www\.|)youtu\.be/ig) || uri_link.match(/(www\.|)vimeo\.com\/[0-9]{1,}/ig))) {
    ...
    // deactivate_plugins();
  } else if (sitegroupvideoPlugin && (uri_link.match(/(www\.|)youtube\.com\/watch/ig) || uri_link.match(/(www\.|)youtu\.be/ig) || uri_link.match(/(www\.|)vimeo\.com\/[0-9]{1,}/ig))) {
    ...
    sitegroupvideoPlugin.elements.formInput.value = uri_link;
    sitegroupvideoPlugin.doAttach();
    sitegroupvideoPlugin.active = true;
    // deactivate_plugins();
  } else if (sitestorevideoPlugin && (uri_link.match(/(www\.|)youtube\.com\/watch/ig) || uri_link.match(/(www\.|)youtu\.be/ig) || uri_link.match(/(www\.|)vimeo\.com\/[0-9]{1,}/ig))) {
    ...
    sitestorevideoPlugin.elements.formInput.value = uri_link;
