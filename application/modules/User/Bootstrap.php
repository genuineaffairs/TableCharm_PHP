...
class User_Bootstrap extends Engine_Application_Bootstrap_Abstract
{
  ...
  protected function _initRequest() {
    ...
    if($view !== null) {
      $file = 'user_global.css';
      $view->headLink()->appendStylesheet($view->layout()->staticBaseUrl . 'application/modules/User/externals/styles/' . $file);
    }
    Zend_Registry::get('Zend_Controller_Front')->registerPlugin(new User_Plugin_Core());
  }
}
