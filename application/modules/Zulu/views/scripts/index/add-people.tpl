...
<?php
$this->headLink()->appendStylesheet($this->layout()->staticBaseUrl . 'application/css.php?request=/application/modules/Zulu/externals/css/ajax_member_list.css'); ?>
<?php
$this->headScript()
...
<script type="text/javascript">
  ...
  en4.core.runonce.add(function() {
   // if( !isPopulated ) { 
      new Autocompleter.Request.JSON('user_ids', '<?php echo $this->url(array('module' => 'zulu', 'controller' => 'index', 'action' => 'get-members'), 'default', true) ?>', {
      'postVar' : 'user_ids',
      'postData' : false,
			'minLength': 1,
			'delay' : 250,
...
<script type="text/javascript">
    parent.onAddPeople(
      '<?php echo $this->user_ids; ?>', '<?php echo $this->access_type; ?>'
    );
