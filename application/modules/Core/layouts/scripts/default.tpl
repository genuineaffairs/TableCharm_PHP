...
<head>
  ...
  <?php
    ...
    $this->headLink(array(
        'rel' => 'apple-touch-icon', 'href' => ( $staticBaseUrl . 'apple-touch-icon-57x57-precomposed.png')
      ),
      'APPEND');

    $this->headLink(array(
        'rel' => 'apple-touch-icon', 'sizes' => '72x72', 'href' => ( $staticBaseUrl . 'apple-touch-icon-72x72-precomposed.png')
      ),
      'APPEND');

    $this->headLink(array(
        'rel' => 'apple-touch-icon', 'sizes' => '114x114', 'href' => ( $staticBaseUrl . 'apple-touch-icon-114x114-precomposed.png')
      ),
      'APPEND');

    $this->headLink(array(
        'rel' => 'apple-touch-icon', 'sizes' => '144x144', 'href' => ( $staticBaseUrl . 'apple-touch-icon-144x144-precomposed.png')
      ),
      'APPEND');
...
<body id="global_page_<?php echo $identity ?>">
  ...
  <?php if ($this->translate($pageTitle) == "pagetitle-core-index-index"): ?>
    <?php if ($this->viewer()->getIdentity() == ""): ?>
    <div id="global_header" class="home_page">
    <?php else: ?>
