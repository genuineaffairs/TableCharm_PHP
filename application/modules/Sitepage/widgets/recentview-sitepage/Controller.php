 ...
 */
class Sitepage_Widget_RecentviewSitepageController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->sitepages = Engine_Api::_()->getDbtable('pagestatistics', 'sitepage')->recentViewList($params);
