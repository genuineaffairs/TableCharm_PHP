<?php defined("_ENGINE") or die("access denied"); return array (
  ...
  array (
    ...
    array (
      ...
      'reqs' => 
      array (
        'action' => '(index|browse|create|delete|list|manage|edit|calendar|add-location|event-badge|promote-calendar|calendar-badge|view-more)',
      ),
    ),
    'event_specific' => 
    array (
      ...
      'reqs' => 
      array (
        'action' => '(edit|delete|join|leave|invite|accept|style|reject|promote)',
        'event_id' => '\\d+',
      ),
    ),
    'event_profile' => 
