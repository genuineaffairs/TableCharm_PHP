 ...
 * @license    http://www.socialengine.com/license/
 */
class Messages_Model_DbTable_Conversations extends SharedResources_Model_DbTable_Abstract
{
  ...
  public function send(Core_Model_Item_Abstract $user, $recipients, $title, $body, $attachment = null, $source = null)
  {
    $resource = null;
    ...
    if($source && $source instanceof Core_Model_Item_Abstract) {
      $params['source_type'] = $source->getType();
      $params['source_id'] = $source->getIdentity();
    }
    
    // Create conversation
    $conversation = $this->createRow();
    $conversation->setFromArray($params);
    $conversation->save();
