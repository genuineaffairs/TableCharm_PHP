 ...
 * @license    http://www.socialengine.com/license/
 */
class User_Form_Signup_Custom extends Engine_Form
{
  public function init()
  {
    ...
    // $this->first_name->getValidator('NotEmpty')->setMessage('Please enter a first name.', 'isEmpty');
    ...
    // $this->last_name->getValidator('NotEmpty')->setMessage('Please enter a last name.', 'isEmpty');
