                ...
                foreach ($this->paginator as $content): $i++;
                    ...
                    <li class="admin_file admin_file_type_<?php echo $content['type'] ?>" id="<?php echo $id ?>">
                        ...
                        <div class="admin_file_options">
                            ...
                            | <?php echo $this->htmlLink($this->url(array('action' => 'edit')) . '?bg=' . $contentKey, $this->translate('edit'), array('class' => 'smoothbox')) ?>
                        </div>
                        <div class="admin_file_name <?php echo $content['is_active'] ? 'active' : '' ?>" title="<?php echo $contentKey ?>">
                            <?php if ($content['name'] == '..'): ?>
