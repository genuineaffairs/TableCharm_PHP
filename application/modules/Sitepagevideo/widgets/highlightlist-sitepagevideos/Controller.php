 ...
 */
class Sitepagevideo_Widget_HighlightlistSitepagevideosController extends Engine_Content_Widget_Abstract {
...
//     $sitepagevideo_getFeatured = Zend_Registry::isRegistered('sitepagevideo_getFeatured') ? Zend_Registry::get('sitepagevideo_getFeatured') : null;
//     if ( empty($sitepagevideo_getFeatured) ) {
//       return $this->setNoRender();
//     }
