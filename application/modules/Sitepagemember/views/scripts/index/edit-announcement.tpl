	...
	<div class="layout_middle">
		...
		<div class="sitepage_edit_content">
			<div class="sitepage_edit_header">
				...
				<a style="margin-right:7px;" href='<?php echo $this->url(array('action' => 'announcements', 'page_id' => $this->page_id), 'sitepage_dashboard', true) ?>'><?php echo $this->translate('Back to Manage Announcements'); ?></a>
