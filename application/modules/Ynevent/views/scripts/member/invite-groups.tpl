<script>
	...
	en4.core.runonce.add(function(){
		...
		$$('input[type=checkbox]').addEvent('click', function(){
			...
			if (flag) {
				$$('optional input[type=checkbox]')[0].checked = true;
			}
			else {
				$$('optional input[type=checkbox]')[0].checked = false;
			}
		});
	});*/
</script>
...
<form class="global_form_popup" action="" method="post">	
	...
	<div id="buttons-wrapper" class="form-wrapper">
		...
		<br/>
		<a onclick="parent.Smoothbox.close();" href="javascript:void(0);" type="button" id="cancel" name="cancel"><?php echo $this->translate('cancel');?></a>
	</div>	
	<?php
	else:
	?>
    ...
    <div id="buttons-wrapper" class="form-wrapper">
		<fieldset id="fieldset-buttons">
			...
			<button onclick="return checkSelect();" type="submit" id="btnSubmit" name="btnSubmit"><?php echo $this->translate('Send Invites');?></button>
 			or <a onclick="parent.Smoothbox.close();" href="javascript:void(0);" type="button" id="cancel" name="cancel"><?php echo $this->translate('cancel');?></a>
