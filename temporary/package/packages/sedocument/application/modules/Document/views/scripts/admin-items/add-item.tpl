 ...
 * @version    $Id: add-item.tpl 6590 2010-08-11 9:40:21Z SocialEngineAddOns $
...
<script type="text/javascript">
  ...
  {
    var contentAutocomplete = new Autocompleter.Request.JSON('title', '<?php echo $this->url(array('module' => 'document', 'controller' => 'items', 'action' => 'get-item'), 'admin_default', true) ?>', {
      'postVar' : 'text',
      'minLength': 1,
      'selectMode': 'pick',
    ...
    contentAutocomplete.addEvent('onSelection', function(element, selected, value, input) {
      $('document_id').value = selected.retrieve('autocompleteChoice').id;
    });
