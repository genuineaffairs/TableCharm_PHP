 ...
 * @version    $Id: TopicController.php 9800 2012-10-17 01:16:09Z richard $
 * @author     John
 */
...
class Event_TopicController extends Core_Controller_Action_Standard {
  ...
  public function deleteAction() {
    ...
    return $this->_forward('success', 'utility', 'core', array(
                ...
                'messages' => array(Zend_Registry::get('Zend_Translate')->_('Your topic has been deleted successfully.')),
            ));
  }
