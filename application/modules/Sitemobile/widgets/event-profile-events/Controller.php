 ...
 * @license    http://www.socialengine.com/license/
 */
class Sitemobile_Widget_EventProfileEventsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    if (($paginator->getTotalItemCount() <= 0) || empty($sitemobileEventProfile)) {
      return $this->setNoRender();
    }
