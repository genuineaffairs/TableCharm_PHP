 ...
 */
class Sitepageevent_Widget_ProfileBreadcrumbeventController extends Engine_Content_Widget_Abstract {

  //ACTION FOR SHOWING THE PAGE PROFILE BREADCRUMB ON EVENT VIEW PAGE
  public function indexAction() {   
    ...
    $this->view->sitepage = $sitepage = Engine_Api::_()->getItem('sitepage_page', $sitepageevent_subject->page_id);
