INSERT IGNORE INTO `engine4_core_modules` (`name`, `title`, `description`, `version`, `enabled`, `type`) VALUES  ('ynevent', 'Advanced Event', 'Advanced Event', '4.02', 1, 'extra') ;
...
('ynevent_main_create', 'ynevent', 'Create New Event', 'Ynevent_Plugin_Menus', '{"route":"event_general","action":"create"}', 'ynevent_main', '', 1, 0, 4),
...
('core_admin_main_plugins_ynevent', 'ynevent', 'Advanced Events', '', '{"route":"admin_default","module":"ynevent","controller":"manage"}', 'core_admin_main_plugins', '', 1, 0, 999),
...
('ynevent_main_calendar', 'ynevent', 'My Calendar', 'Ynevent_Plugin_Menus', '{"route":"event_general","action":"calendar"}', 'ynevent_main', '', 1, 0, 5)
;
-- Alter event table
...
('ynevent_topic_reply', 'ynevent', '{item:$subject} replied to a {item:$object:topic} in the event {itemParent:$object:event}: {body:$body}', 1, 3, 1, 1, 1, 1),
('ynevent_photo_upload', 'ynevent', '{item:$subject} added {var:$count} photo(s).', 1, 3, 2, 1, 1, 1),
('ynevent_topic_create', 'ynevent', '{item:$subject} posted a {item:$object:topic} in the event {itemParent:$object:event}: {body:$body}', 1, 3, 1, 1, 1, 1)
;
