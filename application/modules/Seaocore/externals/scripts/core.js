...
en4.seaocore.setShareButtons = function(wrapper, cont, params) {
  ...
  if (cont.getElement('.linkedin_container')) {
    ...
    new Element('script', {'src': 'http://platform.linkedin.com/in.js'}).inject($('global_content'), 'before');

  }
  if (cont.getElement('.twitter_container')) {
    new Element('script', {'src': 'http://platform.twitter.com/widgets.js'}).inject($('global_content'), 'before');
