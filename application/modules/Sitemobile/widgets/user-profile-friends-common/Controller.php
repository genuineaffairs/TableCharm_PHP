 ...
 * @license    http://www.socialengine.com/license/
 */
class Sitemobile_Widget_UserProfileFriendsCommonController extends Engine_Content_Widget_Abstract {
...
//    $col2 = 'resource_id';
    ...
    $sitemobileCommonFriend = Zend_Registry::isRegistered('sitemobileCommonFriend') ?  Zend_Registry::get('sitemobileCommonFriend') : null;
    ...
    // Do not render if nothing to show
    if (($paginator->getTotalItemCount() <= 0) || empty($sitemobileCommonFriend)) {
      return $this->setNoRender();
    }
