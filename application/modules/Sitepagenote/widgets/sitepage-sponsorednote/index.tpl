...
<ul class="sitepage_sidebar_list">
  <?php foreach ($this->recentlyview as $sitepagenote): ?>
    <li>             
  ...
  <li class="sitepage_sidebar_list_seeall">
		<a href='<?php echo $this->url(array('sponsorednote'=> 1), 'sitepagenote_browse', true) ?>'><?php echo $this->translate('See All');?> &raquo;</a>
	</li>
</ul>