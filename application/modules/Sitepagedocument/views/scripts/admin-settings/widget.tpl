...
<h2>
  <?php echo $this->translate("Directory / Pages - Documents Extension") ?>
</h2>
...
<?php endif; ?>
<h3>
  <?php echo $this->translate("Ajax based Tabbed widget for Documents") ?>
</h3>
	...
	<div class="list_head">
	  <div style="width:23%">
	   ...
	   <div style="width:23%" class="admin_table_centered">
	    <?php echo $this->translate("No. of Documents");?>
	  </div>
	  <div style="width:23%" class="admin_table_centered">
    	...
    	<ul>
      	<?php foreach ($this->tabs as $item) : ?>
        	<li>
	          ...
	          <div style="width:23%;" class='admin_table_centered'>
	            <?php echo ( $item->enabled ? $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitepagedocument', 'controller' => 'settings', 'action' => 'enabled', 'tab_id' => $item->tab_id), $this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Seaocore/externals/images/approved.gif', '', array('title' => $this->translate('Disable Tab'))), array())  : $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitepagedocument', 'controller' => 'settings', 'action' => 'enabled', 'tab_id' => $item->tab_id), $this->htmlImage($this->layout()->staticBaseUrl.'application/modules/Seaocore/externals/images/disapproved.gif', '', array('title' => $this->translate('Enable Tab')))) ) ?>
	          </div>
	          <div style="width:23%;" class='admin_table_centered'>          
