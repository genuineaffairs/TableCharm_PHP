...
<script type="text/javascript">
  var quotePost = function(user, href, body) {
    ...
    tinyMCE.activeEditor.setContent('[blockquote]' + '[b][url=' + href + ']' + user + '[/url] <?php echo $this->translate('said');?>:[/b]\n' + htmlspecialchars_decode(body) + '[/blockquote]\n\n');
      ...
      <div class="group_discussions_thread_details">
        <div class="group_discussions_thread_details_options">
          <?php if( $this->form ): ?>
            ...
            echo $this->htmlLink(array('controller' => 'post','action' => 'report', 'reset' => false,'post_id' => $post->getIdentity()), $this->translate('Report'), array(
            		'class' => 'buttonlink smoothbox icon_group_post_report'
                ))
             ?>
