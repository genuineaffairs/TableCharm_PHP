 ...
 */
class Sitetagcheckin_Widget_BylocationEventController extends Engine_Content_Widget_Abstract {

  public function indexAction() {
    
    // Make form
    $this->view->form = $form = new Sitetagcheckin_Form_Locationsearch();
    ...
    $result = Engine_Api::_()->sitetagcheckin()->getEventSelect($values);
