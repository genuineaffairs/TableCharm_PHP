 ...
 */
class Communityad_Widget_LeftNoneController extends Engine_Content_Widget_Abstract
{
	public function indexAction()
	{
		$load_content = 0;
		$page_setting = Engine_Api::_()->communityad()->getNonWidgetLimit('communityad.left-none');
		...
		if (!empty($_GET['load_content']) || empty($ajax_enabled)) {
		  $load_content = 1;
			...
			$this->view->communityad_left_none = $communityad_left_none = Zend_Registry::get( 'communityad_left_none' );
			if( empty($communityad_left_none) ) {
