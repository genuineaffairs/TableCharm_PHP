 ...
 */
class Communityad_Widget_ExtendedNoneController extends Engine_Content_Widget_Abstract
{
	public function indexAction()
	{
		$page_setting = Engine_Api::_()->communityad()->getNonWidgetLimit('communityad.extended-none');
		...
		if (!empty($_GET['load_content']) || empty($ajax_enabled)) {
		  $load_content = 1;
			...
			$this->view->extend_none = $communityad_extended_none = Zend_Registry::get( 'communityad_extend_none' );
			if( empty($communityad_extended_none) ) {
