 ...
 */
class Sitepagedocument_Widget_PopularSitepagedocumentsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $sitepagedocument_populardoc = Zend_Registry::isRegistered('sitepagedocument_populardoc') ? Zend_Registry::get('sitepagedocument_populardoc') : null;
    if (empty($sitepagedocument_populardoc)) {
      return $this->setNoRender();
    }
