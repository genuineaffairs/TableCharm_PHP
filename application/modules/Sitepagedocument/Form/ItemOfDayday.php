 ...
 */
class Sitepagedocument_Form_ItemOfDayday extends Engine_Form {
  ...
  public function init() {
    ...
    $this->setTitle('Add a Document of the Day')
            ->setDescription('Select a start date and end date below.This document will be displayed as "Document of the Day" for this duration.If more than one documents of the day are found for a date then randomly one will be displayed.');
