 ...
 */
class Sitepagealbum_Widget_SearchSitepagealbumController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    //FORM CREATION
    $this->view->form = $form = new Sitepagealbum_Form_Searchwidget(array('type' => 'sitepage_page'));
    $populateValue = 0;
