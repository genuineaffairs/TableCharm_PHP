...
sitebusinesspoll', 'sitebusinessmusic', 'sitebusinessvideo', 'sitebusinessreview', 'sitebusinessmember', 'sitebusinessurl');
        ...
        if( empty($isSettingsTab) ) {
          $db->query("INSERT IGNORE INTO `engine4_core_menuitems` (`name`, `module`, `label`, `plugin`, `params`, `menu`, `submenu`, `enabled`, `custom`, `order`) VALUES ('seaocore_admin_settings', 'seaocore', 'Settings', NULL , '{\"route\":\"admin_default\",\"module\":\"seaocore\",\"controller\":\"settings\"}', 'seaocore_admin_main', NULL , '1', '0', '8');");
        }
