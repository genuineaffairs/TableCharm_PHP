...
<form method="post" class="global_form_popup">
  <div>
    ...
    <p>
      <?php echo $this->translate('Are you sure that you want to delete this page note ? It will not be recoverable after being deleted.'); ?>
    </p>
    <br />
    <p>
      <input type="hidden" name="confirm" value="<?php echo $this->note_id ?>"/>
