...
<p><?php echo $this->translate('Your members will be asked to provide some information about their folders when creating a new folder. Create some folder questions that allow them to provide more detailed folders in a way that relates to the theme of your community. To reorder the folder questions, click on their names and drag them up or down.'); ?>
</p>
