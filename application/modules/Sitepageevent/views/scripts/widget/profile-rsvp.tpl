 ...
 * @version    $Id: profile-rsvp.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
...
<?php if ($this->viewer_id): ?>
    ...
    var refreshEventStats = function() {
      new Request.HTML({
        ...
        onSuccess: function(responseJSON, responseText, responseHTML, responseJavaScript) {
          if($('sitepageevent_profile_index-main-left-sitepageevent_profile_info')) {
            $('sitepageevent_profile_index-main-left-sitepageevent_profile_info').innerHTML = responseHTML;
          }
        }  
      }).send();
    }
  ...
  <form class="sitepageevent_rsvp_form" action="<?php echo $this->url() ?>" method="post" onsubmit="return false;">
    <div class="sitepageevents_rsvp" id="rsvp_options">
