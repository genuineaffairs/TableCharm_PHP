 ...
 */
class Sitepagepoll_Widget_CommentSitepagepollsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->listCommentPolls = $listCommentPolls = Engine_Api::_()->getDbtable('polls', 'sitepagepoll')->getPollListing('Most Commented', $values);
