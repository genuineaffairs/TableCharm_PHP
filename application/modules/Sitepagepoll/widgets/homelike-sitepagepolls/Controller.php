 ...
 */
class Sitepagepoll_Widget_HomelikeSitepagepollsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->listLikedPolls = $listLikedPolls = Engine_Api::_()->getDbtable('polls', 'sitepagepoll')->getPollListing('like_poll', $values);
