...
<li id="user-widget-request-<?php echo $this->notification->notification_id ?>">
  <div class="ui-link-inherit">
    ...
    <h3><?php echo $this->translate('%1$s has sent you a friend request.', $this->htmlLink($this->notification->getSubject()->getHref(), $this->notification->getSubject()->getTitle())); ?></h3>
