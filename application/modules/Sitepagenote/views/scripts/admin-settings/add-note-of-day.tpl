 ...
 * @version    $Id: add-note-of-day.tpl 2011-08-026 9:40:21Z SocialEngineAddOns $
...
<script type="text/javascript">
  ...
  {
    var contentAutocomplete = new Autocompleter.Request.JSON('title', '<?php echo $this->url(array('module' => 'sitepagenote', 'controller' => 'settings', 'action' => 'get-note'), 'admin_default', true) ?>', {
      'postVar' : 'text',
      'minLength': 1,
      'selectMode': 'pick',
