 ...
 * @version    $Id: readme.tpl 6590 2010-08-11 9:40:21Z SocialEngineAddOns $
...
<div class="tabs">
	<ul class="navigation">
    <li class="active">
       <a href="<?php echo $this->baseUrl() .'/admin/document/settings/readme'?>" ><?php echo $this->translate('Please go through these important points and proceed by clicking the button at the bottom of this page.') ?></a>
    </li>
	</ul>
</div>		
...
<script type="text/javascript" >
	function form_submit() {
		var url='<?php echo $this->url(array('module' => 'document', 'controller' => 'settings'), 'admin_default', true) ?>';
