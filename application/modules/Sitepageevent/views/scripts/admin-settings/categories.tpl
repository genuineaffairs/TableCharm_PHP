  ...
  <div class='clear'>
    ...
    <form class="global_form">
      <div>
        ...
        <p class="description">
          <?php echo $this->translate("Below, you can add and manage the various categories for the page events on your site.") ?>
        </p>
...
<?php //              <th># of Times Used</th>?>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php echo $this->htmlLink(
																array('route' => 'default', 'module' => 'sitepageevent', 'controller' => 'admin-settings', 'action' => 'edit-category', 'id' =>$category->category_id),
																$this->translate('edit'),
																array('class' => 'smoothbox',
                        )) ?>
                        |
                        <?php echo $this->htmlLink(
																array('route' => 'default', 'module' => 'sitepageevent', 'controller' => 'admin-settings', 'action' => 'delete-category', 'id' =>$category->category_id),
      ...
      <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'sitepageevent', 'controller' => 'settings', 'action' => 'add-category'), $this->translate('Add New Category'), array(
