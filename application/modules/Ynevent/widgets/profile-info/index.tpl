...
<div id='ynevent_stats'>
  <ul>
    ...
    <li>
    	...
    	<div class="ynevent_stats_content"><?php echo $this->subject->price ?><?php echo $this->translate('$')?></div>
    </li>
    <?php endif ?>
    ...
    <li>
      ...
      <div class="ynevent_stats_content">
      	...
      	<a id="ynevent_widget_profile_info_map_href" target="blank" href="#"><?php echo $this->translate('Map')?></a>
      </div>
    </li>
    <?php endif ?>
    ...
    <?php if( !empty($this->subject->host) ): ?>
      <?php if( $this->subject->host != $this->subject->getParent()->getTitle()): ?>
        <li>
          ...
          <div class="ynevent_stats_content"><?php echo $this->subject->host ?></div>
        </li>
      <?php endif ?>
      <li>
    ...
    <li>
    	...
    	<div class="ynevent_stats_content" title="<?php echo $this->subject->email ?>"><a href="mailto:<?php echo $this->subject->email ?>" target="_blank"><?php echo (strlen($this->subject->email) > 18) ? (substr($this->subject->email , 0, 18) . '...') : ($this->subject->email); ?></a></div>
    </li>
    <?php endif ?>
    ...
    <li>
    	...
    	<div class="ynevent_stats_content"><a href="<?php echo $this->subject->url ?>" title="<?php echo $this->subject->url ?>"><?php echo (strlen($this->subject->url) > 16) ? (substr($this->subject->url , 0, 16) . '...') : ($this->subject->url); ?></a></div>
    </li>
    <?php endif ?>
...
window.addEvent('domready', function() {
	...
	if (tab_id){
		var el = $("ynevent_widget_profile_info_map_href");
		if ( el != null && el != undefined)
			el.set('href','<?php echo $this->subject->getHref()?>?tab='+tab_id);
	}
	else{
