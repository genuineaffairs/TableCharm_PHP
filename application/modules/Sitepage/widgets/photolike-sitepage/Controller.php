...
class Sitepage_Widget_PhotolikeSitepageController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->is_ShowLightBox = $sitepagealbum_isShowLightBox = Zend_Registry::isRegistered('sitepagealbum_isShowLightBox') ? Zend_Registry::get('sitepagealbum_isShowLightBox') : null;

    if (empty($sitepagealbum_isShowLightBox)) {
      return $this->setNoRender();
    }   
