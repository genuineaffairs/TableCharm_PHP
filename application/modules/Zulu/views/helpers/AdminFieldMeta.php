 ...
 * @author     John
 */
class Zulu_View_Helper_AdminFieldMeta extends Zend_View_Helper_Abstract
{
  public function adminFieldMeta($map)
  {
    ...
    elseif ($meta->type == 'subheading') {
      $containerClass = 'heading subheading';
    }
    else {
    ...
    // If Field Label is underscore character, We set the value of Label to First Option
    if($meta->canHaveDependents() && $meta->label === '_') {
