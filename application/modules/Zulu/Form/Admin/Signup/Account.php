...
class User_Form_Admin_Signup_Account extends Engine_Form
{
  public function init()
  {
    ...
    // Element: age limit
    $this->addElement('Radio', 'guardianverification', array(
      'label' => 'Guardian Verification',
      'description' => 'USER_FORM_ADMIN_SIGNUP_GUARDIAN_VERIFICATION_DESCRIPTION',
      'multiOptions' => array(
        1 => 'Yes, require age verification via guardian\'s email below the age limit of 15.',
        0 => 'No, do not require verification from a guardian for members under the age limit of 15.'
      ),
      'value' => 1,
    ));
