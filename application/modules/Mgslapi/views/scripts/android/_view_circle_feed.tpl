      ...
      <div class="match_info">
            ...
            <div class="action_menu">
                <ul>
                    ...
                    <?php if($hasLike):?>
                        <li><a href="#circle_like@like_id=<?php echo $hasLike[0]['like_id']; ?>" id="do_like_circle"><?php echo $this->translate('Unlike');?></a></li>
                    <?php else:?>
                        <li><a href="#circle_like@like_id=0" id="do_like_circle"><?php echo $this->translate('Like');?></a></li>
                    <?php endif;?>
        ...
        <div class="event_option">
            <ul>
                ...
                <li class="lastchild"><a id="do_event_circle" href="#circle_event_list@circle_id=1">Events</a></li>
                <div  class="clear"></div>
            </ul>
        </div>
        <!-- end event content -->
