...
<div class='layout_middle'>
  ...
  <div id="loading" class="browse_loading" style="display: none;">
    <img src="/application/modules/Core/externals/images/loading.gif" alt="Loading">
    Loading ...
  </div>
  <a id="back_to_top_button" href="#" class="seaocore_up_button Offscreen" title="Scroll to Top">
    <span></span>
  </a>
</div>
