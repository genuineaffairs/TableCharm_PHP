 ...
 * @version    $Id: upload-photo.tpl 9800 2012-10-17 01:16:09Z richard $
 * @author     John
 */
/**
 * @category   Application_Core
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  echo'current' ?>"><span><a href="<?php echo $this->layout()->staticBaseUrl . 'externals/tinymce/themes/advanced/image.htm'; ?>" onmousedown="return false;">{#advanced_dlg.image_title}</a></span></li>
        <li id="general_tab" class="<?php if (!$this->status)
  echo'current' ?>"><span><a href="<?php echo $this->layout()->staticBaseUrl . 'externals/tinymce/themes/advanced/upload.htm'; ?>" onmousedown="return false;">Upload</a></span></li>
      </ul>
    </div>
