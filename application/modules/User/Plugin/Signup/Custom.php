 ...
 * @license    http://www.socialengine.com/license/
 */
class User_Plugin_Signup_Custom extends Core_Plugin_FormSequence_Abstract
{
  protected $_name = 'custom';

  protected $_formClass = 'User_Form_Signup_Custom';

  protected $_script = array('signup/form/custom.tpl', 'user');

  protected $_adminFormClass = 'User_Form_Admin_Signup_Custom';

  protected $_adminScript = array('admin-signup/custom.tpl', 'user');
