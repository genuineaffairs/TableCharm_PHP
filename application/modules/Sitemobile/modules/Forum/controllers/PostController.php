 ...
 * @license    http://www.socialengine.com/license/
 */
class Forum_PostController extends Seaocore_Controller_Action_Standard
{
  ...
  public function editAction()
  {
    ...
    try
    {
      ...
      return $this->_gotoRouteCustom(array('post_id'=>$post->getIdentity(), 'topic_id' => $post->getParent()->getIdentity()), 'forum_topic', true);
    }
