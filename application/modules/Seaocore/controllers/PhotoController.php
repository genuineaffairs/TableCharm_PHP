...
//         }
      ...
      case "advalbum":
        ...
        if (Engine_Api::_()->getDbtable('modules', 'core')->isModuleEnabled('sitealbumalbum')) {
          ...
          $this->view->rating_count = Engine_Api::_()->sitealbum()->ratingCount($photo->getIdentity(), 'album_photo');
          $this->view->photo = $photo;
          $this->view->rated = Engine_Api::_()->sitealbum()->checkRated($photo->getIdentity(), 'album_photo');
        }
        break;
