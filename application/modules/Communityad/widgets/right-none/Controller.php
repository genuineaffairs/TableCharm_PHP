 ...
 */
class Communityad_Widget_RightNoneController extends Engine_Content_Widget_Abstract
{
	public function indexAction()
	{
		$load_content = 0;
		$page_setting = Engine_Api::_()->communityad()->getNonWidgetLimit('communityad.right-none');
		...
		if (!empty($_GET['load_content']) || empty($ajax_enabled)) {
		  $load_content = 1;
			...
			$this->view->communityad_right_none = $communityad_right_none = Zend_Registry::get( 'communityad_right_none' );
			if( empty($communityad_right_none) ) {
