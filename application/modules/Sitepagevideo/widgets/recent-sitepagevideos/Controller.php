 ...
 */
class Sitepagevideo_Widget_RecentSitepagevideosController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $sitepagevideo_getRecent = Zend_Registry::isRegistered('sitepagevideo_getRecent') ? Zend_Registry::get('sitepagevideo_getRecent') : null;
    if (empty($sitepagevideo_getRecent)) {
      return $this->setNoRender();
    }
