...
//            alert("Data Loaded: " + data);
    ...
    {
        $.post("http://192.168.50.40/iseapi/ios/api/v3.0/dump.php", { post_id: action_id },
        function(data) {
    ...
    $(document).ready(function(){
        ...
        newest_feed_id = $( ".bottom" ).first().attr("id");
            ...
            $(window).scroll(function(){
                ...
                //<img alt="Loading" src="http://localhost/iseapi/ios/api/v3.0/images/loading.gif">
                ...
                {               
                    if(ajax_request_in_progress == 0) {
                        ...
                        $.post(baseurl+'ios/api/v3.0/previousfeed',{ maxid: last_feed_id, viewer_id: logged_in_user_id, user_id: profile_user_id, event_id: event_id }, function(data) {
