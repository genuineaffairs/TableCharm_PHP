...
class User_Api_Core extends Core_Api_Abstract
{
  ...
  /**
   * @var int Flag to indicate whether friendship is allowed
   */
  protected $_isFriendShipAllowed;
  ...
  public function getAuthAdapter()
  {
    if( null === $this->_authAdapter ) {
      $db = SharedResources_Model_DbTable_Abstract::getSharedAdapter();
  ...
  public function getParticipationLevelField() {
    $metaData = Engine_Api::_()->fields()->getFieldsMeta('user');
    $field = $metaData->getRowMatching(array('alias' => 'Participation Level'));
    
    return $field;
  }
  
  public function getMedicalRecordProfileTabId() {
  ...
  /**
   * Indicate whether friendship is allowed
   * @return int
   */
  public function isFriendshipAllowed()
  {
    if (!isset($this->_isFriendshipAllowed)) {
      $eligible = (int) Engine_Api::_()->getApi('settings', 'core')->getSetting('user.friends.eligible', 2);
      $this->_isFriendshipAllowed = $eligible;
    }
    return $this->_isFriendshipAllowed;
  }
