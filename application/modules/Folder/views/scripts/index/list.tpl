...
<div class="folder_profile_folders_container">
  ...
  <div class="folder_profile_folders">
    <div class="folder_profile_folders_stats">
      ...
      <?php //if ($this->paginator->getTotalItemCount() > $this->paginator->getCurrentItemCount()): ?>
        -
        <?php echo $this->htmlLink(array('route'=>'folder_general', 'action'=>'browse', 'parent'=>$this->item->getGuid()), 
  ...
  <div class="tip">
    <span>
      <?php echo $this->translate('There are no folders created yet.');?>
        <?php echo $this->htmlLink(array('route'=>'folder_general', 'action'=>'create', 'parent'=>$this->item->getGuid()),
