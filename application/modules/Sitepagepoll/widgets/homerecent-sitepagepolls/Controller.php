 ...
 */
class Sitepagepoll_Widget_HomerecentSitepagepollsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->listRecentPolls = $listRecentPolls = Engine_Api::_()->getDbtable('polls', 'sitepagepoll')->getPollListing('recent_poll', $values);
