 ...
 */
class Sitepage_Widget_MostfollowersSitepageController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->sitepages = Engine_Api::_()->getDbTable('pages', 'sitepage')->getListings('Most Followers',$params,$interval, $sqlTimeStr, array('page_id', 'photo_id', 'page_url', 'title', 'owner_id', 'follow_count'));
