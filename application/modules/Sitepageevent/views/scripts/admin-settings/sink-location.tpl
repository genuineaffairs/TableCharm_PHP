 ...
 * @version    $Id: sink-location.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
...
<form method="post" class="global_form_popup">
  <div>
    <h3><?php echo $this->translate('Sync Page Event Locations with Google Places.'); ?></h3>
    ...
    if (empty($eventCount)) : ?>
			<div class="tip">
				<span> 
					<?php echo $this->translate('There are currently no Page Events on your site to be synced with Google Places.'); ?>
				</span>
			</div>			
    ...
    <?php if (!empty($eventCount)) : ?>
			<p>
				...
				<button type='submit' onClick="getLoading()"><?php echo $this->translate('Sync Page Event Locations'); ?></button>
