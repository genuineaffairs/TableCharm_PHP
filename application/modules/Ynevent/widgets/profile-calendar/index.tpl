...
$next_month_link = '<a href="' . $this->url(array('tab' => $this->identity), 'event_profile') . '?' . 'month=' . ($month != 12 ? $month + 1 : 1) . '&amp;year=' . ($month != 12 ? $year : $year + 1) . '" class="control"><img class="ynevent_arrow" src="application/modules/Ynevent/externals/images/next_rtl.png" /></a>';


/* "previous month" control */
$previous_month_link = '<a href="' . $this->url(array('tab' => $this->identity), 'event_profile') . '?' . 'month=' . ($month != 1 ? $month - 1 : 12) . '&amp;year=' . ($month != 1 ? $year : $year - 1) . '" class="control"><img src="application/modules/Ynevent/externals/images/previous-ltr.png" /></a>';
