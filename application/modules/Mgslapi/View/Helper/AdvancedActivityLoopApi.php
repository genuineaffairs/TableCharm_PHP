 ...
 */
class Advancedactivity_View_Helper_AdvancedActivityLoopApi extends Activity_View_Helper_Activity {

  public function advancedActivityLoopApi($actions = null, array $data = array()) {
