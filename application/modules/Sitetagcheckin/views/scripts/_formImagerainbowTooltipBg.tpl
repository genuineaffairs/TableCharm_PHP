 ...
 * @version    $Id: _formimagerainbowTooltipBg.tpl 6590 2011-07-01 9:40:21Z SocialEngineAddOns $
...
echo '
	<div id="sitetagcheckin_tooltip_bgcolor-wrapper" class="form-wrapper">
		...
		<div id="sitetagcheckin_tooltip_bgcolor-element" class="form-element">
			<p class="description">' . $this->translate('Select a color for the background of the tooltip for the map of check-ins and tagging. (Click on the rainbow below to choose your color.)') . '</p>
