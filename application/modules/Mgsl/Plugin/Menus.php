...
class Mgsl_Plugin_Menus
{
  ...
  public function onMenuInitialize_MgslMiniAdmin($row)
  {
    // @todo check perms
  ...
  public function onMenuInitialize_MgslMiniProfile($row)
  {
    $viewer = Engine_Api::_()->user()->getViewer();
    if( $viewer->getIdentity() ) {
      return array(
  ...
  public function onMenuInitialize_MgslMiniSettings($row)
  {
    $viewer = Engine_Api::_()->user()->getViewer();
    if( $viewer->getIdentity() ) {
      return array(
  ...
  public function onMenuInitialize_MgslMiniAuth($row)
  {
    $viewer = Engine_Api::_()->user()->getViewer();
    if( $viewer->getIdentity() ) {
      return array(
  ...
  public function onMenuInitialize_MgslMiniSignup($row)
  {
    $viewer = Engine_Api::_()->user()->getViewer();
    if( !$viewer->getIdentity() ) {
      return array(
  ...
  public function onMenuInitialize_MgslActivityFeed($row)
  {
    $viewer = Engine_Api::_()->user()->getViewer();
    
    return array(
      'label' => 'Activity Feed',
      'icon' => 'application/modules/Mgsl/externals/images/icons/quick-links/activity_feed.png',
      'route' => 'default'
    );
  }

  public function onMenuInitialize_MgslInviteFriends($row)
  {
    $viewer = Engine_Api::_()->user()->getViewer();
    
    return array(
      'label' => 'Invite friends to join MGSL',
      'icon' => 'application/modules/Mgsl/externals/images/icons/quick-links/invite_friends.png',
      'route' => 'default',
      'params' => array(
        'module' => 'invite'
      )
  ...
  public function onMenuInitialize_MgslBrowseMembers($row)
  {
    $viewer = Engine_Api::_()->user()->getViewer();
    
    return array(
      'label' => 'Browse Members',
      'icon' => 'application/modules/Mgsl/externals/images/icons/quick-links/browse_members.png',
      'route' => 'user_general',
      'params' => array(
        'controller' => 'index',
        'action' => 'browse'
  ...
  public function onMenuInitialize_MgslPrintSharingMed($row)
  {
    return true;
  }
}