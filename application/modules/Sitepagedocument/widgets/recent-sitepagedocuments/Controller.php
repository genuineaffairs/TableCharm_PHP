 ...
 */
class Sitepagedocument_Widget_RecentSitepagedocumentsController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $sitepagedocument_recenttype = Zend_Registry::isRegistered('sitepagedocument_recenttype') ? Zend_Registry::get('sitepagedocument_recenttype') : null;
    if (empty($sitepagedocument_recenttype)) {
      return $this->setNoRender();
    }
