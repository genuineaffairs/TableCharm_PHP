...
<h3>
	<?php echo $this->translate("Directory / Pages Extension Plugins Information") ?>
</h3>
<br />
      ...
      <form method="post" action="" class="global_form_box" enctype="" id="filter_form" name="form1">
        ...
        <div>  
          ...
          <select id="level_id" name="level_id" onchange="document.form1.submit();">
            <option label="" value="1" <?php if( !empty($all_plugin) ) { echo $all_plugin; } ?>><?php echo $this->translate('All Directory / Pages Extensions'); ?> </option>
