...
<ul class="sitepage_sidebar_list">
      ...
      <?php $this->sitepage_subject = Engine_Api::_()->getItem('sitepage_page', $sitepageevent->page_id);?>
          ...
          <?php echo $this->htmlLink($sitepageevent->getHref(), $event_title, array('title' => $sitepageevent->title)) ?>
				...
				<div class='sitepage_sidebar_list_details'>
					...
					?>
					<?php echo $this->translate("in ") . $this->htmlLink(Engine_Api::_()->sitepage()->getHref($sitepageevent->page_id, $sitepageevent->owner_id, $sitepageevent->getSlug()), $page_title, array('title' => $sitepageevent->page_title)) ?> 
				</div>
        <div class="sitepage_sidebar_list_details"> 
  ...
  <li class="sitepage_sidebar_list_seeall">
		<a href='<?php echo $this->url(array('viewedevent'=> 1), 'sitepageevent_browse', true) ?>'><?php echo $this->translate('See All');?> &raquo;</a>
	</li>
</ul>