 ...
 * @license    http://www.socialengine.com/license/
 */
class Sitemobile_modules_Fields_Form_Filter_Search extends Engine_Form {
  ...
  public function generate() {
    ...
    foreach ($structure as $map) {
      ...
      $params['options']['attribs']['onchange'] = 'changeFields(this);';
      ...
      switch ($genericType) {
        ...
        case 'float':
          ...
          $subform->addElement('dummy', 'range-separator', array('label' => "-"));
