 ...
 * @version    $Id: usersink-location.tpl 2012-01-12 9:40:21Z SocialEngineAddOns $
...
<form method="post" class="global_form_popup">
  <div>
    ...
    <p><?php echo $this->translate("Google processes only 2000 requests from an IP address in a day. Thus, you will only be able to sync upto 2000 Members in a day. Make sure that you sync rest of the Members later by visiting this setting again."); ?></p>
    <br />
