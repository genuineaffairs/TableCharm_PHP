 ...
 */
class Sitetagcheckin_View_Helper_SitetagcheckinactivitySM extends Zend_View_Helper_Abstract {

  public function sitetagcheckinactivitySM(Activity_Model_Action $action = null, array $data = array()) {
    ...
    return $this->view->partial(
                    '_sitetagcheckinactivityTextSM.tpl', 'sitetagcheckin', $data
    );
  }
