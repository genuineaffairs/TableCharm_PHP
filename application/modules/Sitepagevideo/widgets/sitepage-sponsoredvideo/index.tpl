...
<ul class="sitepage_sidebar_list">
  <?php foreach ($this->recentlyview as $sitepagevideo): ?>   
  ...
  <li class="sitepage_sidebar_list_seeall">
		<a href='<?php echo $this->url(array('sponsoredvideo'=> 1), 'sitepagevideo_browse', true) ?>'><?php echo $this->translate('See All');?> &raquo;</a>
	</li>
</ul>