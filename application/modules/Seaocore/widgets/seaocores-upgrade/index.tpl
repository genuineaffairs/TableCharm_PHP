...
<?php endif; if( !empty($this->isSitebusiness) && !empty($this->enabledBusinessPlugin) ):?>
	...
	$getBusinessLink = '<a href="' . $businessUrl . '">Click here</a>';
      ?>
      <?php echo $this->translate("To upgrade the latest version of the Extensions for Directory / Business Plugin, %s.", $getBusinessLink); ?><br />&nbsp;&nbsp;
<?php endif; if( !empty($this->isSitegroup) && !empty($this->enabledGroupPlugin) ):?>
      <?php echo $numberFlag++; ?>. <?php
	$getGroupLink = '<a href="' . $this->url(array('module' => 'sitegroup', 'controller' => 'extension', 'action' => 'upgrade'), 'admin_default', true) . '">Click here</a>';
      ?>
      <?php echo $this->translate("To upgrade the latest version of the Extensions for Groups / Communities, %s.", $getGroupLink); ?><br />&nbsp;&nbsp;
<?php endif; if( !empty($this->isSiteevent) && !empty($this->enabledEventPlugin) ):?>
      <?php echo $numberFlag++; ?>. <?php
	$getEventLink = '<a href="' . $this->url(array('module' => 'siteevent', 'controller' => 'extension', 'action' => 'upgrade'), 'admin_default', true) . '">Click here</a>';
      ?>
      <?php echo $this->translate("To upgrade the latest version of the Extensions for Advanced Events Plugin, %s.", $getEventLink); ?><br />&nbsp;&nbsp;
<?php endif; if( !empty($this->isSitereview) && !empty($this->enabledReviewPlugin) ):?>
      <?php echo $numberFlag++; ?>. <?php
	$getEventLink = '<a href="' . $this->url(array('module' => 'sitereview', 'controller' => 'extension', 'action' => 'upgrade'), 'admin_default', true) . '">Click here</a>';
      ?>
      <?php echo $this->translate("To upgrade the latest version of the Extensions for Reviews & Ratings Plugin, %s.", $getEventLink); ?>
<?php endif; ?>
