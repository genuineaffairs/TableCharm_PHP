					...
					if (Engine_Api::_()->sitepage()->allowPackageContent($this->subject->package_id,
						...
						<li> <?php $canShowMessage = false;?>
							...
							<div class="sitepage_getstarted_des">
								...
								?>
									<b><?php echo $this->translate("%s %s", $modNameValue["item_title"], ucfirst($listingType['language_phrases']['text_listings'])); ?></b>
								<?php else: ?>
								...
								if ($modNameValue["resource_type"] == 'sitereview_listing') :
									echo $this->translate("%s new %s %s to this page.", ucfirst($listingType['language_phrases']['text_post']), $item_title, strtolower($listingType['language_phrases']['text_listings'])); ?><?php
								else:
								...
								<div class="sitepage_getstarted_btn">
									<?php if ($modNameValue["resource_type"] == 'sitereview_listing') : ?>
										<a href='<?php echo $this->url(array('action' => 'index','resource_type' => $modNameValue["resource_type"], 'page_id' => $this->page_id, 'listingtype_id' => $modNameValue["listingtype_id"] ),'sitepageintegration_create', true) ?>'><?php echo 	$this->translate("%s / Manage %s %s", ucfirst($listingType['language_phrases']['text_post']), $modNameValue["item_title"], ucfirst($listingType['language_phrases']['text_listings'])); ?></a>
									<?php else: ?>
										<a href='<?php echo $this->url(array('action' => 'index','resource_type' => $modNameValue["resource_type"], 'page_id' => $this->page_id, 'listingtype_id' => $modNameValue["listingtype_id"] ),'sitepageintegration_create', true) ?>'><?php echo $this->translate("Add / Manage %s", $modNameValue["item_title"]);?></a>
									<?php endif; ?>
								</div>
							</div>
						</li>
