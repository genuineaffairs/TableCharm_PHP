...
class Communityad_Widget_BusinessadPreviewController extends Engine_Content_Widget_Abstract 
{
  public function indexAction() 
  {
    ...
    $select
		...
		if($module_name == 'Sitebusiness') {

			//START MANAGE-ADMIN CHECK
			$isManageAdmin = Engine_Api::_()->sitebusiness()->isBusinessOwner($module_subject);
			if(!$isManageAdmin) {
				return $this->setNoRender();
			}
		}
