...
Composer.Plugin.SitepageVideo = new Class({
  ...
  activate : function() {
    ...
    $('compose-sitepagevideo-form-type').options[0] = new Option(this._lang('Choose Source'), '0');
    $('compose-sitepagevideo-form-type').options[1] = new Option(this._lang('YouTube'), '1');
    $('compose-sitepagevideo-form-type').options[2] = new Option(this._lang('Vimeo'), '2');

    if (this.options.allowed == 1){
      $('compose-sitepagevideo-form-type').options[3] = new Option(this._lang('My Computer'), '3');
    }
    //link to full composer for now
    //$('compose-sitepagevideo-form-type').options[3] = new Option('My Computer','3');
