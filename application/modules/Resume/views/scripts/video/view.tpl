...
<script type="text/javascript">
  var resume_id = <?php echo $this->video->resume_id;?>;
  ...
  function rate(rating) {
    ...
    (new Request.JSON({
      'format': 'json',
      'url' : '<?php echo $this->url(array('module' => 'resume', 'controller' => 'video', 'action' => 'rate'), 'default', true) ?>',
      'data' : {
        'format' : 'json',
        'rating' : rating,
        'video_id': video_id,
...
<div class="sitepagevideo_view layout_middle wrapper_padding">
        ...
        if (!empty ($enable_facebookse) && !empty($fbmodule->version)) :
          ...
          if (!empty($fbversion) && ($fbversion >= '4.1.5')) { ?>
             <div class="sitepagevideo_fb_like">
                <script type="text/javascript">
                    var fblike_moduletype = 'resume_video';
  ...
  <div class='sitepage_video_options'>
  	...
  	<?php if($this->can_create):?>
				<a href='<?php echo $this->url(array('resume_id' => $this->resume->resume_id,'tab' => $this->tab_selected_id),'sitepagevideo_create', true) ?>' class='buttonlink icon_type_sitepagevideo_new'><?php echo $this->translate('Add Video');?></a>&nbsp; | &nbsp;
		<?php endif; ?>   
		<?php if($this->video->owner_id == $this->viewer_id || $this->can_edit == 1): ?>
			<?php echo $this->htmlLink(array('route' => 'resume_video_edit', 'video_id' => $this->video->video_id,'resume_id'=>$this->resume->resume_id,'tab'=>$this->tab_selected_id), $this->translate('Edit Video'), array(
						'class' => 'buttonlink icon_type_sitepagevideo_edit'
					)) ?>&nbsp; | &nbsp;

			<?php  echo $this->htmlLink(array('route' => 'resume_video_delete', 'video_id' => $this->video->video_id,'resume_id'=> $this->resume->resume_id,'tab'=> $this->tab_selected_id), $this->translate('Delete Video'), array(
							'class' => 'buttonlink icon_type_sitepagevideo_delete'
						));?> &nbsp; | &nbsp;
    <?php elseif($this->can_create):?>
    <?php endif; ?>
    <?php echo $this->htmlLink(Array('module'=> 'activity', 'controller' => 'index', 'action' => 'share', 'route' => 'default', 'type' => 'resume_video', 'id' => $this->video->getIdentity(), 'format' => 'smoothbox'), $this->translate("Share"), array('class' => 'smoothbox buttonlink icon_type_sitepagevideo_share')); ?>&nbsp; | &nbsp;

    <?php if( $this->can_embed ): ?>
		<?php echo $this->htmlLink(Array('module'=> 'resume', 'controller' => 'video', 'action' => 'embed', 'route' => 'default', 'id' => $this->video->getIdentity(), 'format' => 'smoothbox'), $this->translate("Embed"), array('class' => 'smoothbox buttonlink icon_type_sitepagevideo_embed')); ?>&nbsp; | &nbsp; 
	  <?php endif ?>
   ...
   <?php echo $this->htmlLink(Array('module'=> 'core', 'controller' => 'report', 'action' => 'create', 'route' => 'default', 'subject' =>  $this->video->getGuid(), 'format' => 'smoothbox'), $this->translate("Report"), array('class' => 'smoothbox buttonlink icon_type_sitepagevideo_report')); ?>
	...
	<?php /* echo $this->action("list", "comment", "core", array("type"=>"resume_video", "id"=>$this->video->video_id)) */ ?>
  <div class="wrapper_padding padding_top_medium">
...
<script type="text/javascript">
  function featured(video_id)
  {
    en4.core.request.send(new Request.HTML({
      method : 'post',
      'url' : en4.core.baseUrl + 'resume/video/featured',
      'data' : {
        format : 'html',
        'video_id' : video_id
      },
