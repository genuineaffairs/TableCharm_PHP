...
<?php /* <div class="admin_fields_type">
...
<div class="admin_fields_options">
  ...
  <a href="javascript:void(0);" onclick="void(0);" class="buttonlink admin_fields_options_renametype" style="display:none;">Rename Profile Type</a>
  <?php if( count($this->topLevelOptions) > 1 ): ?>
    <a href="javascript:void(0);" onclick="void(0);" class="buttonlink admin_fields_options_deletetype" style="display:none;">Delete Profile Type</a>
  <?php endif; ?>
  <a href="javascript:void(0);" onclick="void(0);" class="buttonlink admin_fields_options_addtype" style="display:none;">Create New Profile Type</a>
