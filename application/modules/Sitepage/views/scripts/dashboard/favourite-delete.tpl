 ...
 * @version    $Id: favourite-delete.tpl 2011-05-05 9:40:21Z SocialEngineAddOns $
...
<form method="post" class="global_form_popup sitepage_addremove_fav_popup_wrapper">
	<div class="sitepage_addremove_fav_popup_title">
		<?php echo $this->translate('Unlink ') .$this->sitepage->title. $this->translate(" from your Page:") ?>
	</div>
	<div class="sitepage_addremove_fav_popup">
		<div class="sitepage_addremove_fav_popup_img">
			<?php echo $this->htmlLink($this->sitepage->getHref(), $this->itemPhoto($this->sitepage)); ?>
		</div>
		<div class="sitepage_addremove_fav_popup_detail">
			<b><?php echo $this->translate('Select your Page to be unlinked from ') .$this->sitepage->title . $this->translate(".") ?> </b>
			...
			<p>
				<!--<input type="hidden" name="confirm" value="<?php //echo $package['sitepage_id'] ?>"/>-->
