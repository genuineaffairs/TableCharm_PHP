...
<h2>
  <?php echo $this->translate("Directory / Pages - Events Extension") ?>
</h2>
...
<?php endif; ?>
<h3>
  <?php echo $this->translate("Ajax based Tabbed widget for Events") ?>
</h3>
<p>
	...
	<div class="list_head">
	  <div style="width:23%">
	   ...
	   <div style="width:23%" class="admin_table_centered">
	    <?php echo $this->translate("No. of Events");?>
	  </div>
	  <div style="width:23%" class="admin_table_centered">
