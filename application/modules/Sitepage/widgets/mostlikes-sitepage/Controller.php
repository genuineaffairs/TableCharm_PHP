 ...
 */
class Sitepage_Widget_MostlikesSitepageController extends Engine_Content_Widget_Abstract {
  ...
  public function indexAction() {
    ...
    $this->view->sitepages = Engine_Api::_()->getDbTable('pages', 'sitepage')->getListings('Most Likes',$params,$interval, $sqlTimeStr, array('page_id', 'photo_id', 'page_url', 'title', 'owner_id', 'like_count'));
