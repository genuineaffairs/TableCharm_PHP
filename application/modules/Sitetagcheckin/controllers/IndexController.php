...
// 		if (!empty($location)) {
// 			$seao_locationid = Engine_Api::_()->getDbtable('locationitems', 'seaocore')->getLocationItemId($location, '', 'album', $album_id);
// 
// 			Engine_Api::_()->getItemTable('album')->update(array('seao_locationid'=>  $seao_locationid, 'location' => $location), array('album_id =?' => $album_id));
// 		} else {
